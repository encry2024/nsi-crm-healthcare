                                            ...
                                            <div class="field @if($errors->has('q1')) error @endif">
                                                ...
                                                <div class="ui radio checkbox" style="margin-top: 0.5rem !important;">
                                                    ...
                                                    @if(count($record->diabetes_eye_exam) > 0)
                                                        @if ($record->diabetes_eye_exam->q1 == "Yes")
                                                        checked="checked"
                                                        @else
                                                        @endif
                                                    @endif
                                            ...
                                            <div class="field @if($errors->has('q1')) error @endif">
                                                <div class="ui radio checkbox">
                                                    <input type="radio" name="q1" id="q1" value="No"
                                                           @if(count($record->diabetes_eye_exam) > 0)
                                                           @if ($record->diabetes_eye_exam->q1 == "No")
                                                           checked="checked"
                                                    @else
                                                            @endif
                                                            @endif
                                        ...
                                        <div class="three fields">
                                            <div class="field @if($errors->has('q2')) error @endif">
                                                ...
                                                <div class="ui big left icon input">
                                                    <input name="q2" id="pcp_ov"
                                                           @if(count($record->diabetes_eye_exam) > 0)
                                                           value="{{ $record->diabetes_eye_exam->q2 }}"
                                                           @else
                                                           value=""
                                                           @endif
                                                           readonly>
                                            ...
                                            <div class="field @if($errors->has('q3')) error @endif">
                                                ...
                                                <div class="ui big left icon input">
                                                    <input name="q3" id="a1c"
                                                           @if(count($record->diabetes_eye_exam) > 0)
                                                           value="{{ $record->diabetes_eye_exam->q3 }}"
                                                           @else
                                                           value=""
                                                           @endif
                                                           readonly>
                                            ...
                                            <div class="field @if($errors->has('q4')) error @endif">
                                                ...
                                                <div class="ui big left input">
                                                    <input name="q4" id="q4"
                                                           @if(count($record->diabetes_eye_exam) > 0)
                                                           value="{{ $record->diabetes_eye_exam->q4 }}"
                                                           @else
                                                           value=""
                                                            @endif>
                                                </div>
                                            ...
                                            <div class="grouped fields">
                                                <div class="field @if($errors->has('q5')) error @endif">
                                                    ...
                                                    <div class="ui radio checkbox" style="margin-top: 0.5rem !important;">
                                                        <input type="radio" name="q5" id="q5"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q5 == "Yes")
                                                               checked="checked"
                                                               @else
                                                               @endif
                                                               @endif
                                                ...
                                                <div class="field @if($errors->has('q5')) error @endif">
                                                    <div class="ui radio checkbox">
                                                        <input type="radio" name="q5" id="q5"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q5 == "No")
                                                               checked="checked"
                                                               @else
                                                               @endif
                                                               @endif
                                                ...
                                                <div class="field @if($errors->has('q6')) error @endif">
                                                    ...
                                                    <div class="ui radio checkbox" style="margin-top: 0.5rem !important;">
                                                        <input type="radio" name="q6" id="q6"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q6 == "Yes")
                                                               checked="checked"
                                                               @else
                                                               @endif
                                                               @endif
                                                ...
                                                <div class="field @if($errors->has('q6')) error @endif">
                                                    <div class="ui radio checkbox">
                                                        <input type="radio" name="q6" id="q6" value="No"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q6 == "No")
                                                               checked="checked"
                                                        @else
                                                                @endif
                                                                @endif
                                                ...
                                                <div class="field @if($errors->has('q7')) error @endif">
                                                    ...
                                                    <div class="ui radio checkbox" style="margin-top: 0.5rem !important;">
                                                        <input type="radio" name="q7" id="q7"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q7 == "Yes")
                                                               checked="checked"
                                                               @else
                                                               @endif
                                                               @endif
                                                ...
                                                <div class="field @if($errors->has('q7')) error @endif">
                                                    <div class="ui radio checkbox">
                                                        <input type="radio" name="q7" id="q7" value="No"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q7 == "No")
                                                               checked="checked"
                                                        @else
                                                                @endif
                                                                @endif
                                                ...
                                                <div class="field @if($errors->has('q8')) error @endif">
                                                    ...
                                                    <div class="ui radio checkbox" style="margin-top: 0.5rem !important;">
                                                        <input type="radio" name="q8" id="q8"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q8 == "Yes")
                                                               checked="checked"
                                                               @else
                                                               @endif
                                                               @endif
                                                ...
                                                <div class="field @if($errors->has('q8')) error @endif">
                                                    <div class="ui radio checkbox">
                                                        <input type="radio" name="q8" id="q8" value="No"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q8 == "No")
                                                               checked="checked"
                                                        @else
                                                                @endif
                                                                @endif
                                        ...
                                        <div class="field @if($errors->has('q9')) error @endif">
                                            ...
                                            <div class="ui big left input">
                                                <input type="text" name="q9"
                                                       @if(count($record->diabetes_eye_exam) > 0)
                                                       value="{{ $record->diabetes_eye_exam->q9 }}"
                                                       @else
                                                       value=""
                                                        @endif
                                                >
                                                ...
                                                <div class="field @if($errors->has('q10')) error @endif">
                                                    ...
                                                    <div class="ui radio checkbox" style="margin-top: 0.5rem !important;">
                                                        <input type="radio" name="q10" id="q10"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q10 == "Yes")
                                                               checked="checked"
                                                               @else
                                                               @endif
                                                               @endif
                                                ...
                                                <div class="field @if($errors->has('q10')) error @endif">
                                                    <div class="ui radio checkbox">
                                                        <input type="radio" name="q10" id="q10" value="No"
                                                               @if(count($record->diabetes_eye_exam) > 0)
                                                               @if ($record->diabetes_eye_exam->q10 == "No")
                                                               checked="checked"
                                                        @else
                                                                @endif
                                                                @endif
